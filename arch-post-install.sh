...
cp "$SCRIPT_DIR/assets/Catppuccin-Mocha.colorscheme" ~/.local/share/konsole && chmod 644 ~/.local/share/konsole/Catppuccin-Mocha.colorscheme && echo "Copied and set permissions for Catppuccin-Mocha.colorscheme"
